# Third-Party Notices — nirs4all-device

`nirs4all-device` is distributed under `CeCILL-2.1 OR AGPL-3.0-or-later` (plus an optional
commercial license; see [`LICENSING.md`](LICENSING.md)). nirs4all-device does **not** vendor the
...
It is a React/Capacitor application built on the npm/Node ecosystem.
...
| capacitor-community/bluetooth-le | MIT | https://github.com/capacitor-community/bluetooth-le |
